...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    //自定义回调
    private OnSelectStopListener timeStopListener;

    //构造方法
    public TimePickerView(Builder builder) {
        super(builder.context);
        this.timeSelectListener = builder.timeSelectListener;
        this.timeStopListener = builder.timeStopListener;
    ...
    public static class Builder {
        ...
        public Builder setSlideStopListener(OnSelectStopListener timeStopListener){
    ...
    private void initView(Context context) {
        ...
        wheelTime.setListener(timeStopListener);
    }
     ...
     * @return
     */
    public Date returnSlideStopDate(){
        Date date = null;
        try {
