...
import com.xdjd.distribution.adapter.RolloutMakesureOrderAdapter;
...
public class RolloutGoodsSubmitActivity extends BaseActivity {
...
//    private RolloutMakesureOrderAdapter adapter;
    ...
    private int orderType = 1;//订单类型:1.铺货;2.铺货销售;3.撤货
    //去铺货商品列表
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (orderType) {
            case 1:
                ...
                adapter = new NewRolloutMakesureOrderAdapter();
            ...
            case 2:
                ...
                for (PHOrderDetailBean bean : listSaleGoods) {
                    for (PHOrderDetailBean bean1 : bean.getListGoodsData()) {
                        ...
                        strBean.setGoodstype(bean1.getGoodstype());
    ...
    private void distributionOrder() {
        ...
        AsyncHttpUtil<BaseRolloutBean> httpUtil = new AsyncHttpUtil<>(this, BaseRolloutBean.class, new IUpdateUI<BaseRolloutBean>() {
            ...
            public void updata(BaseRolloutBean jsonBean) {
                if ("00".equals(jsonBean.getRepCode())) {
                    ...
                    ToastUtils.showToastInCenterSuccess(RolloutGoodsSubmitActivity.this, jsonBean.getRepMsg());
        ...
        httpUtil.post(M_Url.distributionOrder, L_RequestParams.
                distributionOrder(mClientBean.getCc_id(), mEtRemarks.getText().toString(), imgStr, orderListStr, UserInfoUtils.getLineId(this)), true);
    }
...
//                                    mUserBean.getMobile(), listRolloutGoods, mTvTotalPrice.getText().toString(), false, mEtRemarks.getText().toString());
    ...
    private void eventLaunch() {
        ...
        switch (orderType) {
            case 1:
                intent = new Intent(RolloutGoodsSubmitActivity.this, RolloutGoodsSuccessActivity.class);
    ...
    private void getCustomerBalance() {
        AsyncHttpUtil<CustomerBalanceBean> httpUtil = new AsyncHttpUtil<>(this, CustomerBalanceBean.class, new IUpdateUI<CustomerBalanceBean>() {
            ...
            public void updata(CustomerBalanceBean jsonBean) {
                if ("00".equals(jsonBean.getRepCode())) {
                    ClientBean clientBean = UserInfoUtils.getClientInfo(RolloutGoodsSubmitActivity.this);
                    UserInfoUtils.setCustomerBalance(RolloutGoodsSubmitActivity.this, jsonBean.getBalance());
                    UserInfoUtils.setAfterAmount(RolloutGoodsSubmitActivity.this, jsonBean.getGcb_after_amount());
                    UserInfoUtils.setSafetyArrearsNum(RolloutGoodsSubmitActivity.this, jsonBean.getCc_safety_arrears_num());
