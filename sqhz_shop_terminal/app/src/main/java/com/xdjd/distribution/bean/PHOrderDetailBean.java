...
public class PHOrderDetailBean extends BaseBean implements Cloneable,Serializable{
    ...
    private String totalDebt="0.00";//总欠款
    ...
    private String sign_url_nameref;//签名图片url
