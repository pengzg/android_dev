...
import com.xdjd.distribution.fragment.BeenDistributionFragment;
import com.xdjd.distribution.fragment.BeenPHDistributionFragment;
import com.xdjd.distribution.fragment.NoDistributionFragment;
import com.xdjd.distribution.fragment.NoPHDistributionFragment;
...
public class PHDistributionTaskActivity extends BaseActivity implements LocationListener {
    ...
    private NoPHDistributionFragment mNoDisFragment;
    private BeenPHDistributionFragment mBeenDisFragment;
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            disProgressDialog(PHDistributionTaskActivity.this);
    ...
    protected void initData() {
        ...
        mTitleBar.setTitle("配送任务列表");

        locationUtil = new MyLocationUtil();
        locationUtil.setListener(this);

        mNoDisFragment = new NoPHDistributionFragment();
        mBeenDisFragment = new BeenPHDistributionFragment();
