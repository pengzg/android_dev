...
import com.xdjd.distribution.fragment.SalesOutboundEditFragment;
import com.xdjd.distribution.fragment.SalesOutboundSumbitFragment;
...
public class PlaceOrderActivity extends BaseActivity {
    ...
    private SalesOutboundEditFragment editFragment;
    private SalesOutboundSumbitFragment submitFragment;
    ...
    protected int getContentView() {
        return R.layout.activity_sales_outbound;
    }
    ...
    protected void initData() {
        ...
        editFragment = new SalesOutboundEditFragment();
        submitFragment = new SalesOutboundSumbitFragment();
        ...
        switch (view.getId()) {
            case R.id.left_layout:
                if (mViewpagerCommon.getCurrentItem() == 0) {
                    ...
                    editFragment.refreshData(submitFragment.indexOrder);
                }
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        LogUtils.e("onActivityResult1", "requestCode:" + requestCode + "--resultCode:" + resultCode);
        super.onActivityResult(requestCode, resultCode, data);
        LogUtils.e("onActivityResult2", "requestCode:" + requestCode + "--resultCode:" + resultCode);
