...
public class RolloutGoodsDeclareActivity extends BaseActivity implements NewGoRolloutGoodsAdapter.GoRolloutGoodsListener {
    ...
    private void queryGsCategory() {
        ...
        httpUtil.post(M_Url.phGsCategory, L_RequestParams.
                phGsCategory(clientBean.getCc_id(), String.valueOf(1),storehouseId), true);
    }
    ...
    private void getGoodsList() {
        ...
        httpUtil.post(M_Url.getGoodsList, L_RequestParams.
                getGoodsList(userBean.getUserId(), clientBean.getCc_id(),
                        String.valueOf(1), mTvSearch.getText().toString(), categoryCode, storehouseId,
