...
public class ReceivableDetailAdapter extends BaseAdapter {

    List<ReceivableListBean> list;
    ItemOnListener listener;

    public ReceivableDetailAdapter(ItemOnListener listener) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.item_customer_yks_detail, viewGroup, false);
