...
import com.xdjd.distribution.bean.GiftPrizeDetailBean;
...
public class RedeemActivity extends BaseActivity {
    ...
    private void loadData(String prizeCode) {
        AsyncHttpUtil<GiftPrizeDetailBean> httpUtil = new AsyncHttpUtil<>(this, GiftPrizeDetailBean.class, new IUpdateUI<GiftPrizeDetailBean>() {
            ...
            public void sendFail(ExceptionType s) {
                showProgressDialog(s.getDetail());
                finishActivity();
            }
        ...
        httpUtil.post(M_Url.getGiftPrizeDetailByCode, L_RequestParams.getGiftPrizeDetailByCode(prizeCode), true);
    }
    ...
    private void checkGiftWinning() {
        AsyncHttpUtil<GiftPrizeDetailBean> httpUtil = new AsyncHttpUtil<>(this, GiftPrizeDetailBean.class, new IUpdateUI<GiftPrizeDetailBean>() {
            ...
            @Override
            public void sendFail(ExceptionType s) {
                ToastUtils.showToastInCenterSuccess(RedeemActivity.this,s.getDetail());
                finishActivity();
            }
        ...
        httpUtil.post(M_Url.checkGiftWinning, L_RequestParams.checkGiftWinning(bean.getMw_id()), true);
    }
