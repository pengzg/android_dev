...
public class SelectStoreActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        orderGoodsGoodsId = getIntent().getStringExtra("orderGoodsGoodsId");
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_submit:
                ...
                Intent intent = new Intent(this, OrderDeclareActivity.class);
                ...
                intent.putExtra("note", mEtNode.getText().toString());
                intent.putExtra("orderGoodsId",orderGoodsId);
                intent.putExtra("orderGoodsGoodsId",orderGoodsGoodsId);
            ...
            public void onItem(final int position) {
                ...
                if (beanCopy != null) {
                    if (!storehouseId.equals(listStore.get(position).getBs_id())) {
                        DialogUtil.showCustomDialog(SelectStoreActivity.this, "提示",
