...
public class DistributionTaskActivity extends BaseActivity implements LocationListener {
    ...
    private NoDistributionFragment mNoDisFragment;
    private BeenDistributionFragment mBeenDisFragment;
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            disProgressDialog(DistributionTaskActivity.this);
    ...
    protected void initData() {
        ...
        mNoDisFragment = new NoDistributionFragment();
        mBeenDisFragment = new BeenDistributionFragment();
