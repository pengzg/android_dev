...
public class ShopWinningRecordActivity extends BaseActivity implements CalendarSelectPopup.ItemDateOnListener {
    ...
    protected int getContentView() {
        return R.layout.activity_shop_winning_record;
    }
    ...
    protected void initData() {
        ...
        mLvNoScroll.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (mWinningType == 1){
                    Intent intent = new Intent(ShopWinningRecordActivity.this, CashPrizesRecordAtivity.class);
                    ...
                    Intent intent = new Intent(ShopWinningRecordActivity.this,GoodsUpShopWinningActivity.class);
                    intent.putExtra("dateStartStr", dateStartStr);
                    intent.putExtra("dateEndStr", dateEndStr);
                    intent.putExtra("dateTypeStr", mTvDateTypeSelect.getText().toString());
                    startActivity(intent);
