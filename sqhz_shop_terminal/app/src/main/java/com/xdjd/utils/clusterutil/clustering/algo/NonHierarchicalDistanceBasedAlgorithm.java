...
import com.xdjd.utils.clusterutil.quadtree.PointQuadTree;
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.xdjd.utils.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.xdjd.utils.clusterutil.clustering.algo.StaticCluster<T>(candidate.mClusterItem.getPosition());
                results.add(cluster);
