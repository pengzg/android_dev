...
//                dialog.dismiss();
    ...
    static class Builder{
        ...
        private String ok;
        private String no;
        private MyCustomDialogListener2 listener;
        private int bottomBtnLeftColor;
        private int bottomBtnRightColor;
        ...
        public void titleStr(String titleStr) {
        ...
        public void listener(MyCustomDialogListener2 listener) {
            this.listener = listener;
        }

        public void bottomBtnLeftColor(int bottomBtnLeftColor) {
            this.bottomBtnLeftColor = bottomBtnLeftColor;
        }

        public void bottomBtnRightColor(int bottomBtnRightColor) {
            this.bottomBtnRightColor = bottomBtnRightColor;
        }
