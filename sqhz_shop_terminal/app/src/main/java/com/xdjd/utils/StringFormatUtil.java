...
/**
 * 改变字体颜色工具类
 * Created by lijipei on 2017/1/18.
 */

public class StringFormatUtil {
    private static SpannableStringBuilder spBuilder;
    private static String mWholeStr, mHighlightStr;
    ...
    public static String fillColor(Context context, String wholeStr, String highlightStr, int color){
        mContext=context;
        mWholeStr=wholeStr;
