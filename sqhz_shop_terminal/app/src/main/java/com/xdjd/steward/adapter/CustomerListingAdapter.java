...
public class CustomerListingAdapter extends BaseQuickAdapter<AddressListBean, BaseViewHolder> {


    public CustomerListingAdapter(List<AddressListBean> data) {
        super(R.layout.item_customer_information, data);
    }
