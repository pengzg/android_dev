...
import com.xdjd.steward.adapter.RolloutGoodsSummaryAdapter;
...
public class RolloutGoodsSummaryActivity extends BaseActivity implements CalendarSelectPopup.ItemDateOnListener {
    ...
    private RolloutGoodsSummaryAdapter adapter;
    ...
    protected int getContentView() {
        return R.layout.activity_rollout_goods_summary;
    }
    ...
    protected void initData() {
        ...
        adapter = new RolloutGoodsSummaryAdapter();
        ...
        mLvPull.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                position = position - 1;
                Intent intent = new Intent(RolloutGoodsSummaryActivity.this, RolloutGoodsShopDetailActivity.class);
    ...
    private void loadData() {
        ...
        httpUtil.post(M_Url.phGoodsDetailList, L_RequestParams.phGoodsDetailList(String.valueOf(page), "", "1",
                mTvSearch.getText().toString(),
                dateStartStr.replace(".", "-"), dateEndStr.replace(".", "-")), true);
    }

    @OnClick({R.id.ll_search, R.id.ll_clear, R.id.tv_date_type_select, R.id.ll_date_calendar})
