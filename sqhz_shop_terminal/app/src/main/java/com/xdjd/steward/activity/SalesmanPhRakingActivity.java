...
public class SalesmanPhRakingActivity extends BaseActivity implements OnChartValueSelectedListener,CalendarSelectPopup.ItemDateOnListener {
    ...
    protected int getContentView() {
        return R.layout.activity_salesman_ph_ranking;
    }
    ...
    private void loadData() {
        ...
        httpUtil.post(M_Url.ywySaleRank, G_RequestParams.ywySaleRank(dateStartStr.replace(".","-"), dateEndStr.replace(".","-"), "9999", "1"), true);
    }
