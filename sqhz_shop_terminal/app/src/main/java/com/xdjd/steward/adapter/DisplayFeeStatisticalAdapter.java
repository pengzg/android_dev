...
public class DisplayFeeStatisticalAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(viewGroup.getContext()).
                    inflate(R.layout.item_display_fee_statistical, viewGroup, false);
        ...
        holder.mTvSalesmanName.setText(list.get(i).getEim_salesid_nameref());
