...
public class OrderAllFragment extends BaseFragment implements OrderListAdapter.AllOrderListener{
   ...
   /*上下拉刷新数据*/
    ...
    private void loadData(int isFirst){
        ...
        httpUtil.post(M_Url.GetOrderList, L_RequestParams.GetOrderList(
                UserInfoUtils.getId(getActivity()) ,String.valueOf(pageNo),orderStatus,"N"),false);
    }
