...
public class GoodsCategoryActivity extends BaseActivity implements PurchaseGoodsListener,EditCartNumPopupWindow.editCartNumListener{

    @BindView(R.id.title_bar)
    EaseTitleBar mTitleBar;
    @BindView(R.id.goods_gridview)
    NoScrollGridView mGoodsGridview;
    ...
    private void initView() {
        ...
        whp_id = getIntent().getStringExtra("whp_id");
        ...
        mGoodsGridview.setAdapter(adapter);
        loadCartPriceNum();
    ...
    private void loadData(int isFirst, boolean isDialog) {
        ...
        httpUtil.post(M_Url.getHomegoodsList, L_RequestParams.getHomegoodsList(
                UserInfoUtils.getId(this), whp_id, String.valueOf(pageNo),UserInfoUtils.getStoreHouseId(this)), isDialog);
    }
