package com.xdjd.storebox.popup;
...
public class SelectOrderStatusPopup extends PopupWindow {
    ...
    public SelectOrderStatusPopup(Context context, LinearLayout et, final ItemOnListener listener) {
        super(context);
        this.listener = listener;

        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        view = inflater.inflate(R.layout.popup_select_order_status, null);
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ViewHolder holder;
            if (view == null) {
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ph_select_order_status, parent, false);
