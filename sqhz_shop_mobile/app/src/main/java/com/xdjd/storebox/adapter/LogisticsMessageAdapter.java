...
public class LogisticsMessageAdapter extends BaseAdapter {
    ...
    LogisticsMessageListener listener;
    private List<MessageBean> list;

    public LogisticsMessageAdapter(LogisticsMessageListener listener) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(viewGroup.getContext()).
                    inflate(R.layout.item_logistics_message, viewGroup, false);
    ...
    public interface LogisticsMessageListener {
