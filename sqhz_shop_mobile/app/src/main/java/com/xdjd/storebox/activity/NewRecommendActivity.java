...
public class NewRecommendActivity extends BaseActivity implements PurchaseGoodsListener,EditCartNumPopupWindow.editCartNumListener{
    @BindView(R.id.title_bar)
    EaseTitleBar mTitleBar;
    @BindView(R.id.new_recommend_gridview)
    NoScrollGridView mNewRecommendGridview;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        categoryType = "1";
        //mTitleBar.setTitle("新品推荐");
        title = getIntent().getStringExtra("title");
        mTitleBar.setTitle(title == null ? "推荐商品" : title);
        ...
        mNewRecommendGridview.setAdapter(adapter);
    ...
    private void loadData(int isFirst, boolean isDialog) {
        ...
        httpUtil.post(M_Url.GoodsList, L_RequestParams.getGoodsList(UserInfoUtils.getId(this),"3","",
                String.valueOf(pageNo),"1","","","","",""), false);
        ...
        AsyncHttpUtil<CartBean> httpUtil = new AsyncHttpUtil<>(this, CartBean.class, new IUpdateUI<CartBean>() {
            ...
            public void updata(CartBean bean) {
                if (bean.getRepCode().equals("00")) {
                    ...
                    Intent intent = new Intent(NewRecommendActivity.this, MainActivity.class);
