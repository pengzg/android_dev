...
public class MyCollectActivity extends BaseActivity implements PurchaseGoodsListener,EditCartNumPopupWindow.editCartNumListener{
...
//        loadData(PublicFinal.FIRST, false);
    ...
    private void loadData(int isFirst, boolean isDialog) {
                ...
                if (bean.getRepCode().equals("00")) {
                    if (null != bean.getListData() && bean.getListData().size() > 0) {
                        ...
                        if (mFlag == 2) {
                            ...
                            mViewHelper.showEmptyCartView("还没有收藏商品,去逛逛吧", new View.OnClickListener() {
                                @Override
        ...
        httpUtil.post(M_Url.getFavoriteGoods, L_RequestParams.getFavoriteGoods(
