...
public class L_RequestParams {
     ...
     * @return
     */
    public static RequestParams getNewVersion(String uid, String curVersion) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getHomeIndex(String uid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getGoodsCategory(String uid, String source, String storehouseid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getGoodsList(String uid, String categoryType, String gcCode, String pageNo, String source, String orderType,
     ...
     * @return
     */
    public static RequestParams queryGoodsCarNum(String userId, String ggp_id, String storehouseid, String pa_id) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getSearchList(String uid, String categoryId) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getLogin(Context context, String userPhone, String userPassword) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getRegister(Context context, Register_Params register_params) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "1101");
     ...
     * @return
     */
    public static RequestParams getMsmcode(Context context, String userTel, String smsType, String registerType) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getRegisterArea() {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getCenterShopList(String lat, String lng) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams CheckForgotPhoneNum(String phoneNum) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams CheckRegisterMobile(String mobile) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams SetWeixinLoginPwd(String phoneNum, String smsCode, String password) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getForgotPwd(Context context, String userId, String newPwd, String verificationCode, String phone) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams modifyPassword(String uid, String newPwd, String oldPwd) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getUserInfo(String uid, String userId) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "1102");
        params.put("user", uid);
        params.put("userId", userId);
     ...
     * @return
     */
    public static RequestParams ModifyUserInfo(String uid, String nickName, String birthDay, String shopName) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams ModifyMobile(String uid, String mobile, String smscode) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams GetUserAddressList(String uid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams UserAddressAddModify(String uid, String receiveName, String mobile,
     ...
     * @return
     */
    public static RequestParams DeleteUserAddress(String uid, String usa_id) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams SetDefaultAddress(String uid, String usa_id) {
        RequestParams params = new RequestParams();
     ...
     * @param
     * @param pageNo
     * @param orderPresell 是否预售	N	Y 预售 N非预售
     * @return
     */
    public static RequestParams GetOrderList(String uid, String pageNo, String orderStatus,String orderPresell) {
        RequestParams params = new RequestParams();
        ...
        params.put("orderPresell",orderPresell);//orderPresell	是否预售	N	Y 预售 N非预售
     ...
     * @return
     */
    public static RequestParams GetOrderDetail(String uid, String orderId) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams GetOrderStatus(String uid, String orderId) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams queryCancelReasons(String userId) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "4001");
        params.put("userId", userId);
        return params;
     ...
     * @return
     */
    public static RequestParams CancelOrder(String uid, String orderId, String reasonId, String reason, String version) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams BuyAgain(String uid, String orderId, String storehouseid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams WeixinLogin(String unionid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams CommitFeedback(String uid, String mobile, String content) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams MeFeedbackList(String uid, String pageNo, String rows) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams ConnectWX(String userId, String unionid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams clearWxData(String userId){
        RequestParams params = new RequestParams();
        setCommonParams(params, "1123");
        params.put("userId", userId);
        Log.e("绑定微信", params.toString());
     ...
     * @return
     */
    public static RequestParams Advertise(String ai_platform, String shop) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams PromoteUser(String uid, String searchKey, int pageNo) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams PromoteStatistic(String uid, String isAll, String type) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams PromoteOrder(String uid, String rows, int pageNo) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams PromoteRank(String uid, int pageNo) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams GetPendingOrderList(String uid, String orderType, String pageNo, String searchKey) {
        RequestParams params = new RequestParams();
    ...
    public static RequestParams GetIntegralDetailList(String userId, String pageNo, String rows, String type) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams GetIntegralGoodsList(String userId, String pageNo, String rows, String searchType
    ) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams GetIntegralGoodsDetail(String userId, String wig_id) {
        RequestParams params = new RequestParams();
    ...
    public static RequestParams GetIntegralOrder(String userId, String pageNo, String rows) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams GetIngetralGrade(String userId) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams alterCart(String uid, String goodsId, String gpId, String goodsNum, String supplierid, String activityId, String center_shop) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams editCart(String userId, String ggp_id, String c_goods_num, String storehouseid, String pa_id) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams addFavoriteBatch(String userId, String favoriteType, String favoriteids, String isFavorite/*,String cartIds,String center_shop*/) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "2004");
        params.put("userId", userId);
     ...
     * @return
     */
    public static RequestParams getGoodsDetail(String uid, String pricePlanId, String gp_id, String storehouseid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getCartList(String uid, String storehouseid) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "2003");
        params.put("userId", uid);
        params.put("storehouseid", storehouseid);
     ...
     * @return
     */
    public static RequestParams getCleartCart(String uid, String center_shop, String storehouseid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getDeleteCart(String uid, String cartIds, String center_shop, String storehouseid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getSingleAmount(String uid, String cartIds, String center_shop) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getCartInfo(String uid, String center_shop, String storehouseid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams addCartByScan(String userId, String shop, String goodsInteCode) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams bulidSettlementOrder(String userId, String cartIds,
     ...
     * @return
     */
    public static RequestParams createOrder(String userId, String cartIds, String payMethod,
     ...
     * @return
     */
    public static RequestParams addFavorite(String user, String favoriteType, String favoriteid, String isFavorite) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getHomeList(String user) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "1501");
     ...
     * @return
     */
    public static RequestParams getRecommendGoods(String userId, String page, String stroehouseid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getFocus(String user) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "4001");
        params.put("userId", user);
     ...
     * @return
     */
    public static RequestParams getHomeActivity(String user, String localtion) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getHomegoodsList(String user, String whp_id, String pageNo, String storehouseid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getActivityGoods(String user, String activityId, String pageNo, String stroehouseid) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "1505");
        params.put("userId", user);
     ...
     * @return
     */
    public static RequestParams getExpireGoodsList(String user, String pageNo) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getBulidCartList(String userId, String cartIds, String type, String storehouseid) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getFavoriteGoods(String user, String pageNo, String storehouseid) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "1506");
        params.put("userId", user);
        params.put("page", pageNo);
     ...
     * @return
     */
    public static RequestParams getUserBuyGoods(String user, String pageNo, String storehouseid) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "2006");
        params.put("userId", user);
        params.put("page", pageNo);
     ...
     * @return
     */
    public static RequestParams searchGoodsList(String user, String pageNo, String searchKey, String storehouseid) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "2004");
        params.put("userId", user);
        params.put("page", pageNo);
     ...
     * @return
     */
    public static RequestParams getPromotionGoods(String user) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "4005");
        params.put("user", user);
        //params.put("shop",shop);
     ...
     * @return
     */
    public static RequestParams getShareParam(String user, String bs_code) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getQuickReg(String mobile, String smsCode, String password, String spread) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams checkMobileAndSpread(String mobile, String spread) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams querySummeryMessage(String user, String shop) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams queryMessageList(String user, String page, String message_type, String shop) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams createIntegralOrderDetail(String userId, String wig_id, String goodsNum, String addressId) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams createIntegralOrder(String userId, String wig_id, String goodsNum, String addressId) {
        RequestParams params = new RequestParams();
     ...
     * @return
     */
    public static RequestParams getGiftPrizeDetailByCode(String userId, String mw_prizecode) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "1704");
        params.put("userId", userId);
     ...
     * @return
     */
    public static RequestParams checkGiftWinning(String userId, String mw_id) {
        RequestParams params = new RequestParams();
        setCommonParams(params, "1704");
        params.put("userId", userId);
     ...
     * @return
     */
    public static RequestParams getWinningList(String userId,String start_time,String end_time,String page
     ...
     * @return
     */
    public static RequestParams getGiftWinningList(String userId,String start_time,String end_time,String page){
        RequestParams params = new RequestParams();
        setCommonParams(params, "1704");
        params.put("userId", userId);
        params.put("end_time", end_time);
     ...
     * @return
     */
    public static RequestParams queryHxPwd(String userId){
        RequestParams params = new RequestParams();
        setCommonParams(params, "1704");
        params.put("userId", userId);
     ...
     * @return
     */
    public static RequestParams setUpHxPwd(String userId,String hxPassword){
        RequestParams params = new RequestParams();
        setCommonParams(params, "1704");
        params.put("userId", userId);
     ...
     * @return
     */
    public static RequestParams queryPhOrderList(String userId,String page,String startDate,String endDate,
                                                 String status){
        RequestParams params = new RequestParams();
        setCommonParams(params, "1704");
        params.put("userId", userId);
        ...
        params.put("startDate",startDate);
        params.put("type","1");//订单类型	Y	1:铺货单 2：铺货销售单 3：撤货单
     ...
     * @return
     */
    public static RequestParams queryPhOrderDetailList(String userId,String orderId){
        RequestParams params = new RequestParams();
        setCommonParams(params, "1704");
        params.put("userId", userId);
        params.put("orderId",orderId);
        params.put("type","1");//1:铺货单详情 2：铺货销售单详情 3：撤货单详情
        LogUtils.e("setUpHxPwd", params.toString());
        return params;
    }
     ...
     * @param userId
     * @param orderId
     * @param type type:1撤货单；type:2 销售单
     * @return
     */
    public static RequestParams saleOrderByPhOrder(String userId,String orderId,String type){
        RequestParams params = new RequestParams();
        setCommonParams(params, "1704");
        params.put("userId", userId);
        params.put("orderId",orderId);
