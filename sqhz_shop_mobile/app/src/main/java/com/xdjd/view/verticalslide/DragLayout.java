package com.xdjd.view.verticalslide;
...
public class DragLayout extends ViewGroup {
	...
	private ShowUpPageNotifier upPageListener;// 手指松开是否加载上一页的notifier
	...
	private void animTopOrBottom(View releasedChild, float yvel) {
		...
		if (releasedChild == frameView1) {
			...
			if (yvel > VEL_THRESHOLD
				...
				// 保持原地不动
				finalTop = viewHeight;
				if(null!=upPageListener){
					upPageListener.onUpPage();
				}
	...
	/**
	 *
	 * @param upPageListener
     */
	public void setUpPageListener(ShowUpPageNotifier upPageListener) {
		this.upPageListener = upPageListener;
	}
	public interface ShowNextPageNotifier {
		public void onDragNext();
	}
	public interface ShowUpPageNotifier{
