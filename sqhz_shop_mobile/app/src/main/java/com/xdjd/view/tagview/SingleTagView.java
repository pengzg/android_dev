...
public class SingleTagView extends SingleLayout implements OnClickListener {
    ...
    private void inflateTagView(final Tag t, boolean b) {
        ...
        TagView localTagView = (TagView) View.inflate(getContext(),
                R.layout.item_select_time_tag, null);
        ...
        if (mIsDeleteMode) {
            ...
            localTagView.setCompoundDrawablesWithIntrinsicBounds(0, 0,
                    R.drawable.delete_01, 0);
        }
        if (t.getTextSize() > 0) {
            localTagView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,
                    t.getTextSize());
        }
        ...
        if (t.getTextResId() > 0) {
            localTagView
                    .setTextColor(getResources().getColor(t.getTextResId()));
        }
                ...
                .setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    public void onCheckedChanged(
                        ...
                        if (SingleTagView.this.mOnTagCheckedChangedListener != null) {
                            SingleTagView.this.mOnTagCheckedChangedListener
                                    .onTagCheckedChanged(
    ...
    public void changeAll() {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (child instanceof TagView) {
                child.setBackgroundResource(mTagViewBackgroundResId);
                ((TagView) child).setTextColor(getResources().getColor(
                        mTagViewTextColorResId));
            }
        }
    }
