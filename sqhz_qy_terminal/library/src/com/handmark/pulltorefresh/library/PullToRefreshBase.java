...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	/**
	 * 是否显示右侧标题栏,true显示,false隐藏
	 */
	private boolean isRightLayout = true;
	...
	//自定义接口回调
	TopTitleListener listener;
	public void setTopTitleTypeListener(TopTitleListener listener){
	...
	final void setState(State state, final boolean... params) {
		...
		//Log.e(LOG_TAG+"--",mState.toString());
		if (listener!=null){
			listener.pullRefreshType(mState);
		}
	...
	protected LoadingLayout createLoadingLayout(Context context, Mode mode,boolean isShowRightLayout, TypedArray attrs) {
		LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
				getPullToRefreshScrollDirection(),isShowRightLayout, attrs);
	 ...
	 * 刷新布局,是否显示刷新控件上面的布局
	 */
	protected void updateUIForRightLayout(){
		mHeaderLayout.updateLayout(isRightLayout);
		mFooterLayout.updateLayout(isRightLayout);
	}
	/**
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START,isRightLayout, a);
		mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END,isRightLayout, a);
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection,boolean isShowRightLayout, TypedArray attrs) {
			switch (this) {
				case ROTATE:
				default:
					return new RotateLoadingLayout(context, mode, scrollDirection, isShowRightLayout,attrs);
				case FLIP:
