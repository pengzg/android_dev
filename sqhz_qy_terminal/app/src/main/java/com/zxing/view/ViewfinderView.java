...
//            paint.setColor(frameColor);
            ...
            // Request another update at the animation interval, but only repaint the laser shape_line_dash,
    ...
    private void drawScanner(Canvas canvas, Rect frame) {
        if (showPossiblePoint) {
            // Draw a red "laser scanner" shape_line_dash through the middle to show decoding is active
