...
package com.bikejoy.utils.clusterutil.clustering.algo;
...
import com.bikejoy.utils.clusterutil.projection.Bounds;
...
import com.bikejoy.utils.clusterutil.quadtree.PointQuadTree;
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.bikejoy.utils.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.bikejoy.utils.clusterutil.clustering.algo.StaticCluster<T>(candidate.mClusterItem.getPosition());
                results.add(cluster);
