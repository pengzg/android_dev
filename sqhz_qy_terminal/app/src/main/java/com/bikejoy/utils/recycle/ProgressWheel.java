package com.bikejoy.utils.recycle;
...
public class ProgressWheel extends View {
    ...
    /**
     * Use onSizeChanged instead of onAttachedToWindow to get the dimensions of the view_dcdcdc,
    ...
    /**
     * Parse the attributes passed to the view_dcdcdc from the XML
     *
    ...
    /**
     * Puts the view_dcdcdc on spin mode
     */
    public void spin() {
        lastTimeAnimated = SystemClock.uptimeMillis();
        isSpinning = true;
    ...
    // Great way to save a view_dcdcdc's state http://stackoverflow.com/a/7089687/1991053
    @Override
