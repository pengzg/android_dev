...
//        if (mLoadingView ==null){
//            mLoadingView = mViewHelper.inflate(R.layout_date_select_style.layout_loadingview);
//            mLoadingView.setClickable(true);
//        }
//
...
//        startProgressLoading();
    ...
    public void showEmptyView(String tips){
        ...
        if (!TextUtils.isEmpty(tips)){
            TextView tv = (TextView) mEmptyView.findViewById(R.id.empty_tips_show);
...
//        stopProgressLoading();
    ...
    public void showEmptyView(String tips, View.OnClickListener listener){
        ...
        if (!TextUtils.isEmpty(tips)){
            ...
            tv.setVisibility(View.VISIBLE);
            tv.setText(tips);
            tv.setTextColor(UIUtils.getColor(R.color.text_gray_b3b3));
        }
