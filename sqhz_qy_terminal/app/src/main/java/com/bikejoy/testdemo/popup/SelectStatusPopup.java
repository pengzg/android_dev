...
public class SelectStatusPopup extends PopupWindow {
    ...
    public SelectStatusPopup(Context context, LinearLayout et, final ItemOnListener listener) {
        super(context);
     ...
     * @param listener
     */
    public SelectStatusPopup(Context context, int width, final ItemOnListener listener) {
        super(context);
        this.listener = listener;
