...
public class SelectShopPopup extends PopupWindow {
    ...
    public SelectShopPopup(Context context, TextView et, final ItemOnListener listener) {
        super(context);
        this.listener = listener;

        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        view = inflater.inflate(R.layout.popup_select_shop, null);
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            holder.mTvName.setText(list.get(position).getMs_name());
