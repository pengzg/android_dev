...
public class QsAndRechargeOrderFragment extends BaseFragment implements CalendarSelectPopup.ItemDateOnListener {
    ...
    private QsOrderListAdapter adapter;
    ...
    /**
     *
     * @param orderType 订单类型 1 水票订单  2 送水订单 3 购物订单 4 充值订单
     */
    public QsAndRechargeOrderFragment(String orderType) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_qs_order, container, false);
    ...
    public void OnActCreate(Bundle savedInstanceState) {
        ...
        adapter = new QsOrderListAdapter();
        adapter.setData(list);
        adapter.setListener(new QsOrderListAdapter.OnOrderListListener() {
            @Override
    ...
    @OnClick({R.id.tv0, R.id.tv1, R.id.tv2, R.id.tv_date_type_select, R.id.ll_date_calendar})
