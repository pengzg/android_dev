		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (monthView == null) {
				monthView = MonthView.create(parent, inflater,
						...
						displayHeader, headerTextColor, decorators);
			}
//			System.out.println("1"+months.toString());
//			System.out.println("2"+cells.toString());
//			System.out.println("3"+displayOnly);
//			System.out.println("4"+titleTypeface);
//			System.out.println("5"+dateTypeface);
//			Date date = new Date();
//			String current=date.getYear()+"-"+date.getMonth();
//			String str=months.get(position).getYear()+"-"+months.get(position).getMonth();
//		    boolean a=current.equals(str);
